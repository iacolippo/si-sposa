...
const translations = {
  it: {
    ...
    matrimonio: {
      ...
      festaTitolo: 'Ines e Iacopo saranno felici di salutare gli amici al Castello di Villa Russiz. Vi preghiamo di confermare la vostra presenza con una email al nostro super wedding planner Stefano Pilotto a ',
  ...
  fr: {
    ...
    matrimonio: {
      ...
      festaTitolo: "Ines et Iacopo seront heureux de saluer leurs amis au Château de Villa Russiz. Merci de confirmer votre présence par un email à notre super wedding planner Stefano Pilotto à ",
      festaEmail: 'stefano.pilotto@mib.edu',
      festaOra: '18h00',
      festaLuogo: 'Villa Russiz',
      festaIndirizzo: 'Via Russiz 4/6, Capriva del Friuli',
